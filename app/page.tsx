            ...
            <div className="mt-8 p-6 bg-card rounded-xl border border-border">
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li className="flex items-start gap-2 group">
                  ...
                  <HelpCircle className="w-4 h-4 text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity cursor-help" title="File must be valid JSON format" />
                </li>
                <li className="flex items-start gap-2 group">
                  <span className="text-primary mt-0.5">&#10003;</span>
                  <div className="flex-1">
                  ...
                  <HelpCircle className="w-4 h-4 text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity cursor-help" title="Large files may take longer to process" />
                </li>
                <li className="flex items-start gap-2 group">
                  <span className="text-primary mt-0.5">&#10003;</span>
                  <div className="flex-1">
                  ...
                  <HelpCircle className="w-4 h-4 text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity cursor-help" title="Required: url (string), html (string), text (array of strings)" />
                </li>
                <li className="flex items-start gap-2 group">
                  <span className="text-primary mt-0.5">&#10003;</span>
                  <div className="flex-1">
                  ...
                  <HelpCircle className="w-4 h-4 text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity cursor-help" title="Download extension from button above" />
                </li>
              </ul>
            </div>
          </div>
